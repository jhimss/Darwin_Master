package com.github.orangegangsters.lollipin.lib.activity;
...
public class ReceiveActivity extends Activity implements View.OnClickListener {
    ...
    private TextView mToolbarText,tap_scan;
    ...
    private void initView() {
        ...
        tap_scan=(TextView)findViewById(R.id.tap_scan);
        tap_scan.setOnClickListener(this);
